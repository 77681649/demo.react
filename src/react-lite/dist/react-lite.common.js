...
function initVelem(velem, parentContext, namespaceURI) {
  ...
  var rootNode = createElement(velem);
...
function initVcomponent(vcomponent, parentContext, namespaceURI) {
  ...
  var component = createComponentInstance(Component, props, parentContext);
  ...
  component.setCache({ vnode: vnode, node: node, isMounted: true });
...
Updater.prototype = {
  ...
  clearPendingStateQueue: function clearPendingStateQueue() {
...
Component.prototype = {
  ...
  tryEmitComponentWillMount: function tryEmitComponentWillMount() {
...
function renderTreeIntoContainer(vnode, container, callback, parentContext) {
  ...
  var rootNode = renderDOMTreeToContainer(id, vnode, container, parentContext);
...
function getContainerID(container) {
  return container[COMPONENT_ID] || (container[COMPONENT_ID] = getUid());
}
...
function updateContainerArgument(id, newArgument) {
  var argument = getContainerArgument(id);
  var oldCallback = argument.callback;
  var newCallback = newArgument.callback;
